...
- **Slash command**: `/auditlens` — invoke explicitly
...
cp -r skills/auditlens ~/.claude/skills/auditlens
...
/skills
```
You should see `auditlens` in the list.

## Method 3: Claude.ai Web (Upload .skill file)

1. Download `auditlens.skill` from Releases
